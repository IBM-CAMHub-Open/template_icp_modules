...
`myuser:SomeLongPwd@myprivateregistry.local/ibmcom/icp-inception:2.1.0.2`
...
module "icpprovision" {
    ...
    icp_configuration = {
      "network_cidr"              = "x.x.0.0/16"
      "service_cluster_ip_range"  = "y.16.0.1/24"
...
module "icpprovision" {
    ...
    image_location = "nfs:<path>/ibm-cloud-private-x86_64-2.1.0.1.tar.gz"
    parallell-pull = True
